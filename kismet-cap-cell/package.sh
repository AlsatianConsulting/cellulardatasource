...
Kismet source config:
  - Ensure plugin is loaded:
      plugin=${KISMET_PREFIX}/lib/kismet/cell/manifest.conf
  - Ensure datasource drop-ins are loaded:
      opt_include=/etc/kismet/datasources.d/*.conf
  - Runtime phone bridges are managed by cell_autoconfig.sh + kismet-cell-bridge.service.
